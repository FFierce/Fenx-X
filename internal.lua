...
EditorFrame.TopImage = "rbxassetid://13279758192"
...
title.Text = "Lightsploit | Internal UI"
...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "Lightsploit | Not injected! Press attach.)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    print("hi")
    if injected == true then
        title.Text = "Lightsploit | Already Injected!"
        wait(1)
        title.Text = "Lightsploit | Internal UI"
    end
    if injected == false then
        title.Text = "checking..."
        wait(0.1)
        title.Text = "Lightsploit | Injecting..."
        wait(1.5)
        title.Text = "verifying.."
        wait(0.8)
        title.Text = "scanning.."
        wait(0.3)
        title.Text = "Lightsploit is ready!"
        wait(0.5)
        title.Text = "Lightsploit | Internal UI"
        injected = true
    end
...
title_2.ZIndex = 14
title_2.Image = "http://www.roblox.com/asset/?id=13279758192"
...
title_3.Text = "Lightsploit | Script Hub"
...
title_4.ZIndex = 110
title_4.Image = "http://www.roblox.com/asset/?id=13279758192"
...
while true do
    ...
    if scripthub_2.Visible == true then
        ...
        if scriptselected == "dex" then
            descri.Text = "A script to search for scripts, either univsersal or game-specific."
        end
        if scriptselected == "esp" then
            descri.Text = "A universal admin-gui panel with over 500 commands."
        end
        if scriptselected == "spy" then
            descri.Text = "A script for bedwars known as Vape V4. This script does not include the pistonware plugin."
        end
        if scriptselected == "dumper" then
            descri.Text = "Save in-game models."
        end
    end
end
